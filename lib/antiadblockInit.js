...
exports.initAntiAdblockNotification = function initAntiAdblockNotification()
{
  ...
  function addAntiAdblockNotification(subscription)
  {
    ...
    notifications.addQuestionListener(notification.id, notificationListener);
  }

  function removeAntiAdblockNotification()
  {
    notifications.removeNotification(notification);
    notifications.removeQuestionListener(notification.id, notificationListener);
  }
  ...
  function onSubscriptionChange(subscription)
  {
    ...
    if (filterStorage.hasSubscription(subscription) && subscription.disabled)
