...
export function setElementLinks(idOrElement, ...actions)
{
...
export function stripTagsUnsafe(text)
{
...
export function setElementText(element, stringName, args, children = [])
{
