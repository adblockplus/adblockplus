...
const {allureEnabled, chromeEnabled, edgeEnabled} = helpers.testConfig;
...
if (chromeEnabled)
{
  browserCapabilities.push({
    ...
    "goog:chromeOptions": {
      args: ["--no-sandbox",
              `--load-extension=${chromeExtensionPath},${helpers.helperExtensionMV3}`,
              `--disable-extensions-except=${chromeExtensionPath},${helpers.helperExtensionMV3}`],
